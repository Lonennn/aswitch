...
- After pulling the repository line-ending policy change on an existing clone, run `git add --renormalize .` once to refresh tracked files under the new `LF` rules.
